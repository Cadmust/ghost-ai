...
| Artifact   | Vercel Blob                | Canas snapshots and generated Markdown specs |
...
- Project records, spec records, and task run recrds belong in PostgreSQL.
...
3. Auth and ownership are enforced at every mutation buondary.
4. Client componentes are used only where browser interactivity or real-time state requires them.
