...
3. Wire React Flow to Liveblocks state.
    ...
    - pass the synced nodes, egdes, and change handlers into `ReactFlow`
...
- don't add custom node or edge rendring yet
- don't add persistence logic
- don't add AI behavior
- keep this focused on the bollaborative canvas foundation
