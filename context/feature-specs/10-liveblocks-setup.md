...
Add a helper that deterministically maps a user ID to a consistenct color from a fixed palette.
...
2. verify project access using the exisitng access helper
